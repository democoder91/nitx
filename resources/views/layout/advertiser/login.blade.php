<x-advertiser.auth-layout>
    ...
    <div class="row align-items-center justify-content-center h-100 mx-4 mx-sm-n32">
        <div class="col-12 col-md-9 col-xl-7 col-xl-9 px-8 px-sm-0 pt-24 pb-48">
            ...
            <form class="mt-16 mt-sm-32 mb-8" method="POST" action="{{ route('ADLogin') }}">
                @csrf
                @error('failed')
                ...
                <div class="row align-items-center justify-content-between mb-16">
                    ...
                    <div class="col hp-flex-none w-auto">
                        <a class="small text-muted text-underline--dashed border-primary" href="auth-recover.html">Forgot
                            Password?</a>
                    </div>
                </div>
            ...
            <div class="col-12 hp-form-info">
                ...
                <a class="text-primary-1 hp-text-color-dark-primary-2 hp-caption" href="{{ route('ADRegister') }}">Create
                    an account</a>
            </div>
