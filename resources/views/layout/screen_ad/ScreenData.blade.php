<x-page-layout>
    <div class="col-10" style="margin: 0 auto">
        ...
        <form action="{{ route('newScreenEvent', $screenId) }}" method="post">
            @csrf
                    ...
                    <div class="row">
                        @foreach ($categories as $category)
                            <div class="col-6 col-md-3" style="margin-top:1.5em">
                                <div class="hp-select-box-item">
                                    <input type="checkbox" hidden="" name="category[]" value="{{ $category->id }}"
            ...
            <hr/>
            <button class="btn btn-primary" type="submit" onclick="setTimeDurationAfterSubmittingFormToDisableButton(30000, 'create-screen')" id="create-screen">Submit</button>
        </form>
    </div>
</x-page-layout>
</div>
